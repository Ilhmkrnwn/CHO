...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="{{ route('setting') }}"><i class="fa fa-cogs"></i> Pengaturan</a></li>
        ...
        <div id="page-wrapper">
            ...
            <div class="colm">
                <div class="col-lg-6">
                    <form action="{{ url('edit/' .$pelangans->id)}}" method="post">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                            <label>Nomor Tujuan</label>
                            <input class="form-control" value="{{$pelangans -> no_hp}}" name="noTujuan" autofocus required>
                        </div>
                        <div class="form-group">
                            <label>JUMLAH</label>
                            <input class="form-control" id="option" value="{{$pelangans -> jumlah}}" name="jumlah" required>
                            </input>
                            <script>
                        ...
                        <div class="form-group">
                            <label>Harga</label>
                            <input class="form-control" value="{{$pelangans -> jumlah}}" name="harga" autofocus required>
                        </div>
